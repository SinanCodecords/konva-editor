...
const ColorControls = ({
    ...
    const [borderColorFormat, setBorderColorFormat] = useState<"string" | "hex" | "rgb">("hex");
            ...
            <div className="space-y-4">
                ...
                {textStyle.hasBorder && (
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-2 items-center">
                            <Select value={borderColorFormat} onValueChange={(value: "string" | "hex" | "rgb") => setBorderColorFormat(value)}>
                                <SelectTrigger className="w-24">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
